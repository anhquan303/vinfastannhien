...
```
cd existing_repo
git remote add origin https://gitlab.com/anhquannguyen303/vinfastannhien.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/anhquannguyen303/vinfastannhien/-/settings/integrations)
